...
import { ChevronDown, Home, Waves, TreePine, User, LogOut, Sparkles } from "lucide-react";
              ...
              >
                ...
                <DropdownMenuItem asChild>
                  <Link 
                    ...
                    className="group relative select-none rounded-sm text-sm outline-none hover:bg-gradient-to-r hover:from-red-600 hover:to-green-600 hover:text-white data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 flex items-center gap-3 px-3 py-2 cursor-pointer transition-all font-medium bg-[#ffffff] text-[#000000]"
                  >
                    <Sparkles className="h-4 w-4" />
                    <div>
                      <div className="font-medium">🎄 Christmas Lights</div>
                      <div className="text-xs text-slate-500 group-hover:text-white">Holiday lighting visualizations</div>
                    </div>
                  </Link>
                </DropdownMenuItem>
              </DropdownMenuContent>
          ...
          <div className="md:hidden">
            <DropdownMenu>
              ...
              >
                ...
                <DropdownMenuItem asChild>
                  <Link href="/christmas-lights" className="flex items-center gap-2 px-3 py-2 hover:bg-slate-100">
                    <Sparkles className="h-4 w-4" />
                    🎄 Christmas Lights
                  </Link>
                </DropdownMenuItem>
