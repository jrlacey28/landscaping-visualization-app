...
export default function AuthPage() {
  ...
  const handleLogin = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Allow time for auth state to fully propagate before redirect
      setTimeout(() => {
        if (planId) {
          redirectToCheckout(planId);
        } else {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-800 via-slate-900 to-black py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-4">
              <div className="p-4 border-2 border-gray-200 rounded-lg bg-white shadow-sm hover:shadow-md transition-shadow">
                <Button
                  type="button"
                  variant="ghost"
                  className="w-full flex items-center justify-center gap-2 py-3 bg-transparent hover:bg-gray-50 border-2 border-gray-300 hover:border-gray-400 transition-colors text-gray-700 hover:text-gray-700"
