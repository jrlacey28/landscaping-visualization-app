            ...
            <CardContent className="space-y-6 text-slate-200">
              ...
              <section>
                ...
                <div className="space-y-3">
                  ...
                  <p><strong>Basic Plan:</strong> $20/month - 100 visualizations per month</p>
                  <p><strong>Pro Plan:</strong> $100/month - 200 visualizations per month plus embed features</p>
